<?php
/* Smarty version 3.1.31, created on 2017-06-06 21:57:51
  from "/home/lsconnect/dev.ls-connect.us/content/themes/default/templates/admin.settings.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5937255f6f6df4_84741131',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e7dd8d4536c3a3c8d3f3092656730d891d88dc1f' => 
    array (
      0 => '/home/lsconnect/dev.ls-connect.us/content/themes/default/templates/admin.settings.tpl',
      1 => 1490026270,
      2 => 'file',
    ),
  ),
...
function content_5937255f6f6df4_84741131 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="system_public" class="onoffswitch-checkbox" id="system_public" <?php if ($_smarty_tpl->tpl_vars['system']->value['system_public']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="system_public"></label>
                        </div>
                        <span class="help-block">
                            <?php echo __("Disable it to prevent non logged users to view website content");?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="directory_enabled" class="onoffswitch-checkbox" id="directory_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['directory_enabled']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="directory_enabled"></label>
                        </div>
                        <span class="help-block">
                            <?php echo __("Enable or Disable the directory (website must be public too)");?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="market_enabled" class="onoffswitch-checkbox" id="market_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['market_enabled']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="market_enabled"></label>
                        </div>
                        <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="pages_enabled" class="onoffswitch-checkbox" id="pages_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['pages_enabled']) {?>checked<?php }?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="groups_enabled" class="onoffswitch-checkbox" id="groups_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['groups_enabled']) {?>checked<?php }?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="contact_enabled" class="onoffswitch-checkbox" id="contact_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['contact_enabled']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="contact_enabled"></label>
                        </div>
                        <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="verification_requests" class="onoffswitch-checkbox" id="verification_requests" <?php if ($_smarty_tpl->tpl_vars['system']->value['verification_requests']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="verification_requests"></label>
                        </div>
                        <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="profile_notification_enabled" class="onoffswitch-checkbox" id="profile_notification_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['profile_notification_enabled']) {?>checked<?php }?>>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label text-left">
                        <?php echo __("Profile Wall Posts");?>

                    </label>
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="wall_posts_enabled" class="onoffswitch-checkbox" id="wall_posts_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['wall_posts_enabled']) {?>checked<?php }?>>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label text-left">
                        <?php echo __("Advanced Scraper");?>

                    </label>
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="advanced_scraper" class="onoffswitch-checkbox" id="advanced_scraper" <?php if ($_smarty_tpl->tpl_vars['system']->value['advanced_scraper']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="advanced_scraper"></label>
                        </div>
                        <span class="help-block">
                            <?php echo __("Enable or Disable the advanced scraper");?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="geolocation_enabled" class="onoffswitch-checkbox" id="geolocation_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['geolocation_enabled']) {?>checked<?php }?>>
...
.
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=registration">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="registration_enabled" class="onoffswitch-checkbox" id="registration_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['registration_enabled']) {?>checked<?php }?>>
...
/admincp/packages"><?php echo __("Pro Packages");?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="packages_enabled" class="onoffswitch-checkbox" id="packages_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['packages_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="packages_enabled"></label>
                                </div>
                                <span class="help-block">
...
/admincp/settings/payments"><?php echo __("Payments Settings");?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="activation_enabled" class="onoffswitch-checkbox" id="activation_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['activation_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="activation_enabled"></label>
                                </div>
                                <span class="help-block">
...
/admincp/settings/sms"><?php echo __("SMS Settings");?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="age_restriction" class="onoffswitch-checkbox" id="age_restriction" <?php if ($_smarty_tpl->tpl_vars['system']->value['age_restriction']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="age_restriction"></label>
                                </div>
                                <span class="help-block">
...
">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="getting_started" class="onoffswitch-checkbox" id="getting_started" <?php if ($_smarty_tpl->tpl_vars['system']->value['getting_started']) {?>checked<?php }?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="delete_accounts_enabled" class="onoffswitch-checkbox" id="delete_accounts_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['delete_accounts_enabled']) {?>checked<?php }?>>
...
">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="instagram_login_enabled" class="onoffswitch-checkbox" id="instagram_login_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['instagram_login_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="instagram_login_enabled"></label>
                                </div>
                                <span class="help-block">
...
">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="linkedin_login_enabled" class="onoffswitch-checkbox" id="linkedin_login_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['linkedin_login_enabled']) {?>checked<?php }?>>
...
">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="vkontakte_login_enabled" class="onoffswitch-checkbox" id="vkontakte_login_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['vkontakte_login_enabled']) {?>checked<?php }?>>
...
<br/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="email_smtp_ssl" class="onoffswitch-checkbox" id="email_smtp_ssl" <?php if ($_smarty_tpl->tpl_vars['system']->value['email_smtp_ssl']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="email_smtp_ssl"></label>
                                </div>
                                <span class="help-block">
                ...
                <div class="tab-pane" id="Notifications">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=email_notifications">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="email_notifications" class="onoffswitch-checkbox" id="email_notifications" <?php if ($_smarty_tpl->tpl_vars['system']->value['email_notifications']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="email_notifications"></label>
                                </div>
                                <span class="help-block">
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "chat") {?>
            ...
            <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=chat">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="chat_enabled" class="onoffswitch-checkbox" id="chat_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['chat_enabled']) {?>checked<?php }?>>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="chat_status_enabled" class="onoffswitch-checkbox" id="chat_status_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['chat_status_enabled']) {?>checked<?php }?>>
...
">
 ...
 <?php echo __("in kilobytes (1 M = 1024 KB)");?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="photos_enabled" class="onoffswitch-checkbox" id="photos_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['photos_enabled']) {?>checked<?php }?>>
...
">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="audio_enabled" class="onoffswitch-checkbox" id="audio_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['audio_enabled']) {?>checked<?php }?>>
...
">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="file_enabled" class="onoffswitch-checkbox" id="file_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['file_enabled']) {?>checked<?php }?>>
...
.
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="s3_enabled" class="onoffswitch-checkbox" id="s3_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['s3_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="s3_enabled"></label>
                                </div>
                                <span class="help-block">
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "security") {?>
            ...
            <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=security">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="censored_words_enabled" class="onoffswitch-checkbox" id="censored_words_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['censored_words_enabled']) {?>checked<?php }?>>
...
.
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=paypal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="paypal_enabled" class="onoffswitch-checkbox" id="paypal_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['paypal_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="paypal_enabled"></label>
                                </div>
                                <span class="help-block">
...
.
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=stripe">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="creditcard_enabled" class="onoffswitch-checkbox" id="creditcard_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['creditcard_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="creditcard_enabled"></label>
                                </div>
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="alipay_enabled" class="onoffswitch-checkbox" id="alipay_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['alipay_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="alipay_enabled"></label>
                                </div>
                                <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="bitcoin_enabled" class="onoffswitch-checkbox" id="bitcoin_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['bitcoin_enabled']) {?>checked<?php }?>>
                                    <label class="onoffswitch-label" for="bitcoin_enabled"></label>
                                </div>
                                <span class="help-block">
