<?php
/* Smarty version 3.1.31, created on 2017-06-06 22:00:10
  from "/home/lsconnect/dev.ls-connect.us/content/themes/default/templates/admin.packages.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_593725ea208da6_48871289',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '719a1b8ec79e0131376c8a286c5197cd90cc0393' => 
    array (
      0 => '/home/lsconnect/dev.ls-connect.us/content/themes/default/templates/admin.packages.tpl',
      1 => 1490026270,
      2 => 'file',
    ),
  ),
...
function content_593725ea208da6_48871289 (Smarty_Internal_Template $_smarty_tpl) {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="boost_posts_enabled" class="onoffswitch-checkbox" id="boost_posts_enabled" <?php if ($_smarty_tpl->tpl_vars['data']->value['boost_posts_enabled']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="boost_posts_enabled"></label>
                        </div>
                        <span class="help-block">
...
">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="boost_pages_enabled" class="onoffswitch-checkbox" id="boost_pages_enabled" <?php if ($_smarty_tpl->tpl_vars['data']->value['boost_pages_enabled']) {?>checked<?php }?>>
                            <label class="onoffswitch-label" for="boost_pages_enabled"></label>
                        </div>
                        <span class="help-block">
...
'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="boost_posts_enabled" class="onoffswitch-checkbox" id="boost_posts_enabled">
                            <label class="onoffswitch-label" for="boost_posts_enabled"></label>
                        </div>
                        <span class="help-block">
                            <?php echo __("Enable boost posts feature");?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="boost_pages_enabled" class="onoffswitch-checkbox" id="boost_pages_enabled">
                            <label class="onoffswitch-label" for="boost_pages_enabled"></label>
                        </div>
                        <span class="help-block">
                            <?php echo __("Enable boost pages feature");?>
