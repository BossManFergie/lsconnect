<?php
/* Smarty version 3.1.31, created on 2017-06-06 21:56:57
  from "/home/lsconnect/dev.ls-connect.us/content/themes/default/templates/settings.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_59372529420459_81904152',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5e870e0fb0818221bd18bd1a052ee3afc6a1ed5c' => 
    array (
      0 => '/home/lsconnect/dev.ls-connect.us/content/themes/default/templates/settings.tpl',
      1 => 1490026270,
      2 => 'file',
    ),
  ),
...
function content_59372529420459_81904152 (Smarty_Internal_Template $_smarty_tpl) {
                        ...
                        <div class="tab-pane active" id="basic">
                            <form class="js_ajax-forms form-horizontal" data-url="users/settings.php?edit=basic">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="fullname" value="<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_fullname'];?>
">
                                    </div>
                                </div>
                                <div class="form-group">
...
<br>
                            ...
                            <div class="text-center">
                                <button class="btn btn-warning btn-friends js_unverify"><i class="fa fa-clock-o mr5"></i><?php echo __("Pending");?>
</button>
                            </div>
