					...
					{foreach $promoted_products as $post}
						<div class="col-md-4 col-sm-6">
							<div class="thumbnail boosted">
								...
								{else}
									<a class="thumbnail-picture" href="{$system['system_url']}/posts/{$post['post_id']}" style="background-image:url('{$system['system_url']}/content/themes/{$system['theme']}/images/blank_product.png');"></a>
								{/if}
