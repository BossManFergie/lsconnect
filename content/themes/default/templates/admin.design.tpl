                ...
                <div class="col-sm-9">
                    <div>
                        <div class="onoffswitch">
                            <input type="checkbox" name="system_wallpaper_default" class="onoffswitch-checkbox" id="system_wallpaper_default" {if $system['system_wallpaper_default']}checked{/if}>
