                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="affiliates_enabled" class="onoffswitch-checkbox" id="affiliates_enabled" {if $system['affiliates_enabled']}checked{/if}>
                            <label class="onoffswitch-label" for="affiliates_enabled"></label>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="affiliate_type">
                            <option {if $system['affiliate_type'] == "registeration"}selected{/if} value="registeration">
