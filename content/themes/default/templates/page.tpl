                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <div class="panel panel-default">
                            {if $sub_view == ""}
                                ...
                                <div class="panel-body">
                                    <form class="js_ajax-forms form-horizontal" data-url="pages_groups/create.php?type=page&do=edit&id={$spage['page_id']}">
                            ...
                            {elseif $sub_view == "verification"}
                                ...
                                <div class="panel-body">
                                    ...
                                    {elseif $case == "pending"}
                                        ...
                                        <div class="text-center">
                                            <button class="btn btn-warning btn-friends js_unverify" data-id="{$spage['page_id']}"><i class="fa fa-clock-o mr5"></i>{__("Pending")}</button>
                                        </div>
