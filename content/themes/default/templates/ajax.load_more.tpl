{if $get == 'newsfeed' || $get == 'posts_profile' || $get == 'posts_page' || $get == 'posts_group' || $get == 'saved' }
...
{elseif $get == 'post_likes' || $get == 'photo_likes' || $get == 'comment_likes' || $get == 'voters' || $get == 'blocks' || $get == 'affiliates'}
