        ...
        <div class="panel-body">
            <form class="js_ajax-forms form-horizontal" data-url="admin/custom_fields.php?do=edit&id={$data['field_id']}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="mandatory" class="onoffswitch-checkbox" id="mandatory" {if $data['mandatory']}checked{/if}>
                            <label class="onoffswitch-label" for="mandatory"></label>
                        </div>
                        <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="in_registration" class="onoffswitch-checkbox" id="in_registration" {if $data['in_registration']}checked{/if}>
                            <label class="onoffswitch-label" for="in_registration"></label>
                        </div>
                        <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="in_profile" class="onoffswitch-checkbox" id="in_profile" {if $data['in_profile']}checked{/if}>
                            <label class="onoffswitch-label" for="in_profile"></label>
                        </div>
                        <span class="help-block">
        ...
        <div class="panel-body">
            <form class="js_ajax-forms form-horizontal" data-url="admin/custom_fields.php?do=add">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="mandatory" class="onoffswitch-checkbox" id="mandatory">
                            <label class="onoffswitch-label" for="mandatory"></label>
                        </div>
                        <span class="help-block">
                            {__("User must fill the field")}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="in_registration" class="onoffswitch-checkbox" id="in_registration">
                            <label class="onoffswitch-label" for="in_registration"></label>
                        </div>
                        <span class="help-block">
                            {__("Show the field in the registration")}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="in_profile" class="onoffswitch-checkbox" id="in_profile">
                            <label class="onoffswitch-label" for="in_profile"></label>
                        </div>
                        <span class="help-block">
                            {__("Show the field in the user's profile page")}
