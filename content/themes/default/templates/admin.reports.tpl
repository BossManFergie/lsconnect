                    ...
                    {foreach $rows as $row}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {elseif $row['node_type'] == "page"}
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/admincp/pages/edit/{$row['node_id']}" class="btn btn-xs btn-primary">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                {elseif $row['node_type'] == "group"}
