        ...
        <div class="panel-body">
            <form class="js_ajax-forms form-horizontal" data-url="admin/packages.php?do=edit&id={$data['package_id']}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="boost_posts_enabled" class="onoffswitch-checkbox" id="boost_posts_enabled" {if $data['boost_posts_enabled']}checked{/if}>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="boost_pages_enabled" class="onoffswitch-checkbox" id="boost_pages_enabled" {if $data['boost_pages_enabled']}checked{/if}>
