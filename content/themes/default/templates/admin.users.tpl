        ...
        <div class="panel-body">
            ...
            <ul class="nav nav-tabs mb20">
                <li class="active">
                    <a href="#general" data-toggle="tab">
                        <strong class="pr5">{__("General")}</strong>
                    </a>
                </li>
                <li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="general">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/users.php?id={$data['user_id']}&do=edit_general">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="user_banned" class="onoffswitch-checkbox" id="user_banned" {if $data['user_banned']}checked{/if}>
                ...
                <div class="tab-pane" id="username">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/users.php?id={$data['user_id']}&do=edit_username&username={$data['user_name']}">
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-left">
                                {__("Username")}
                            </label>
                ...
                <div class="tab-pane" id="email">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/users.php?id={$data['user_id']}&do=edit_email&email={$data['user_email']}">
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-left">
                                {__("Email address")}
                            </label>
                ...
                <div class="tab-pane" id="password">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/users.php?id={$data['user_id']}&do=edit_password">
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-left">
                                {__("Password")}
                            </label>
