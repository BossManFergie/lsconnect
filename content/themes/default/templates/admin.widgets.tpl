                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {if $row['place'] == "search"}{__("Search Page")}{/if}
                                ...
                                {if $row['place'] == "directory"}{__("Directory")}{/if}
                            </td>
                            <td>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="place">
                            ...
                            <option {if $data['place'] == "search"}selected{/if} value="search">{__("Search Page")}</option>
                            ...
                            <option {if $data['place'] == "directory"}selected{/if} value="photo">{__("Directory")}</option>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="place">
                            ...
                            <option value="search">{__("Search Page")}</option>
