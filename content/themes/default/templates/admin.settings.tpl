            ...
            <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=system">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            {__("Disable it to prevent non logged users to view website content")}
                        </span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="directory_enabled" class="onoffswitch-checkbox" id="directory_enabled" {if $system['directory_enabled']}checked{/if}>
                            <label class="onoffswitch-label" for="directory_enabled"></label>
                        </div>
                        <span class="help-block">
                            {__("Enable or Disable the directory (website must be public too)")}
                        </span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="market_enabled" class="onoffswitch-checkbox" id="market_enabled" {if $system['market_enabled']}checked{/if}>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="contact_enabled" class="onoffswitch-checkbox" id="contact_enabled" {if $system['contact_enabled']}checked{/if}>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="verification_requests" class="onoffswitch-checkbox" id="verification_requests" {if $system['verification_requests']}checked{/if}>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="onoffswitch">
                            <input type="checkbox" name="advanced_scraper" class="onoffswitch-checkbox" id="advanced_scraper" {if $system['advanced_scraper']}checked{/if}>
                            <label class="onoffswitch-label" for="advanced_scraper"></label>
                        </div>
                        <span class="help-block">
                            {__("Enable or Disable the advanced scraper")}
                        </span>
                    </div>
                </div>
                ...
                <div class="tab-pane active" id="General">
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=registration">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="packages_enabled" class="onoffswitch-checkbox" id="packages_enabled" {if $system['packages_enabled']}checked{/if}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="activation_enabled" class="onoffswitch-checkbox" id="activation_enabled" {if $system['activation_enabled']}checked{/if}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="age_restriction" class="onoffswitch-checkbox" id="age_restriction" {if $system['age_restriction']}checked{/if}>
                ...
                <div class="tab-pane" id="Social">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=social_login">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 mt10">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="instagram_login_enabled" class="onoffswitch-checkbox" id="instagram_login_enabled" {if $system['instagram_login_enabled']}checked{/if}>
                ...
                <div class="tab-pane active" id="SMTP">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=emails">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="email_smtp_ssl" class="onoffswitch-checkbox" id="email_smtp_ssl" {if $system['email_smtp_ssl']}checked{/if}>
                ...
                <div class="tab-pane" id="Notifications">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=email_notifications">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="email_notifications" class="onoffswitch-checkbox" id="email_notifications" {if $system['email_notifications']}checked{/if}>
                ...
                <div class="tab-pane" id="S3">
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=s3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="s3_enabled" class="onoffswitch-checkbox" id="s3_enabled" {if $system['s3_enabled']}checked{/if}>
                ...
                <div class="tab-pane active" id="Paypal">
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=paypal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="paypal_enabled" class="onoffswitch-checkbox" id="paypal_enabled" {if $system['paypal_enabled']}checked{/if}>
                ...
                <div class="tab-pane" id="Stripe">
                    ...
                    <form class="js_ajax-forms form-horizontal" data-url="admin/settings.php?edit=stripe">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="creditcard_enabled" class="onoffswitch-checkbox" id="creditcard_enabled" {if $system['creditcard_enabled']}checked{/if}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="alipay_enabled" class="onoffswitch-checkbox" id="alipay_enabled" {if $system['alipay_enabled']}checked{/if}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="onoffswitch">
                                    <input type="checkbox" name="bitcoin_enabled" class="onoffswitch-checkbox" id="bitcoin_enabled" {if $system['bitcoin_enabled']}checked{/if}>
