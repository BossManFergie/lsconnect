    ...
    <div class="post-meta">
        ...
        <div>
            ...
            <span class="post-title">
                ...
                {elseif $origin['post_type'] == "poll"}
                    {__("created a poll")}

                {elseif $origin['post_type'] == "product"}
            ...
            <!-- post feeling -->
            {if $origin['feeling_action']}
            <span class="post-title">
                {__("is")} <i class="twa twa-lg twa-{$origin['feeling_icon']}"></i> {__($origin["feeling_action"])} {__($origin["feeling_value"])}
            </span>
            {/if}
            <!-- post feeling -->
        </div>
