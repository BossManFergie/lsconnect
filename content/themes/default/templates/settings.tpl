                        ...
                        <div class="tab-pane active" id="basic">
                            <form class="js_ajax-forms form-horizontal" data-url="users/settings.php?edit=basic">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="fullname" value="{$user->_data['user_fullname']}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                ...
                {elseif $view == "verification"}
                    ...
                    <div class="panel-body">
                        ...
                        {elseif $case == "pending"}
                            ...
                            <div class="text-center">
                                <button class="btn btn-warning btn-friends js_unverify"><i class="fa fa-clock-o mr5"></i>{__("Pending")}</button>
                            </div>
