...
try {
	...
	switch ($_GET['edit']) {
		case 'system':
			...
			$_POST['advanced_scraper'] = (isset($_POST['advanced_scraper']))? '1' : '0';
			...
			$db->query(sprintf("UPDATE system_options SET 
						...
						geolocation_key = %s ", secure($_POST['system_live']), secure($_POST['system_message']), secure($_POST['system_title']), secure($_POST['system_description']), secure($_POST['system_keywords']), secure($_POST['system_email']), secure($_POST['system_public']), secure($_POST['directory_enabled']), secure($_POST['market_enabled']), secure($_POST['pages_enabled']), secure($_POST['groups_enabled']), secure($_POST['games_enabled']), secure($_POST['contact_enabled']), secure($_POST['verification_requests']), secure($_POST['profile_notification_enabled']), secure($_POST['wall_posts_enabled']), secure($_POST['advanced_scraper']), secure($_POST['geolocation_enabled']), secure($_POST['geolocation_key']) )) or _error(SQL_ERROR_THROWEN);
			break;
